    ...
    */
    describe('RSS Feeds', function() {
        ...
        it('all feeds have a URL defined, and the URL is not empty', function () {
            // expect(allFeeds).toContain(url);
            // expect(allFeeds.url).toBeDefined();
            // expect(allFeeds(0).url).toBeDefined();
            // expect(allFeeds.url(0)).toBeDefined();
            // expect(allFeeds.url).toBe();
            // expect(allFeeds.url[0]).not.toBe[0];
    ...
    describe('The Menu', function() {
         ...
         */
         it('Menu element hidden by default', function (){
          ...
          //  var menu = $('.menu-hidden').hasClass('menu-hidden');
          //  expect(menu.style.display).toBe('true');
          //  expect($('.body').hasClass('menu-hidden')).toBe(true);
          //  expect($('.body').is(':hidden')).toBe(true);
        ...
        it('Menu visibility toggled on icon click', function() {
          // http://stackoverflow.com/questions/38879599/how-do-i-trigger-a-click-event-in-a-jasmine-unit-test-for-an-angular-directive
          ...
          // expect($('menu-icon-link').triggerHandler()).toHaveBeenCalled();
          // expect($('.body').hasClass("menu-hidden")).toBe(false);
          var icon = $('.menu-icon-link');
            icon.click();
            //  $(".menu-icon-link").click();
            // expect(icon).triggerHandler.toHaveBeenCalled();
            // expect(document.body.classList).toContain('menu-hidden');
